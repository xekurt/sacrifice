...
import type { AppScreen } from './gameTypes';
...
const MainMenu: React.FC<MainMenuProps> = ({ onNavigate }) => {
    const handleQuit = () => {
      ...
      <div style="height: 100vh; background: black; color: #71717a; display: flex; align-items: center; justify-content: center; font-family: sans-serif; text-align: center; padding: 2rem;">
        <div>
          <p style="font-size: 1.5rem; letter-spacing: 0.1em; text-transform: uppercase;">The leader has fled.</p>
          <p style="font-size: 0.75rem; color: #3f3f46; margin-top: 1rem;">The system collapses in your absence.</p>
        </div>
      </div>
    `;
        setTimeout(() => {
    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen bg-transparent text-zinc-200 p-4">
            ...
            <div className="flex flex-col gap-3 w-full max-w-[280px]">
                ...
                >
                    <span className="relative z-10 font-black tracking-widest uppercase text-xs">Begin Reign</span>
                </button>
                ...
                >
                    <span className="font-bold tracking-widest uppercase text-[10px]">Settings</span>
                </button>
                ...
                >
                    <span className="font-bold tracking-widest uppercase text-[10px]">Abdicate</span>
                </button>
            </div>
